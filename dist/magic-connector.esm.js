...
var MagicConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  function MagicConnector(_ref) {
    ...
    var apiKey = _ref.apiKey,
        ...
        email = _ref.email;
    !Object.keys(availableNetwork).includes(chainId.toString()) ? process.env.NODE_ENV !== "production" ? invariant(false, "Unsupported chainId " + chainId) : invariant(false) : void 0;
  ...
  _proto.activate = function activate() {
    try {
      ...
      return Promise.resolve(import('magic-sdk').then(function (m) {
        ...
        if (!_this7.magic) {
          if (availableNetwork[_this7.chainId] == 'polygon') {
...
export { FailedVerificationError, MagicConnector, MagicLinkExpiredError, MagicLinkRateLimitError, UserRejectedRequestError };
//# sourceMappingURL=magic-connector.esm.js.map
